...
Upstream pins several of these deps exactly (`mermaid`, `react`, `@excalidraw/*`), which is also why dependabot advisories against those lockfiles cannot be resolved here.
