...
- `~/.claude`, `~/.codex`, and `~/.config/opencode` configs symlink into `~/universe/configs/dotagents`. Edit the source there; changes apply instantly, no home-manager rebuild.
