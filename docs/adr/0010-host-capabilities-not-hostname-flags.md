...
Checking `hostname == "sfx14"` inside shared modules made the name implicitly mean ambient-light sensor, display topology, and other unrelated properties.
...
- `universe.capabilities.handFleet`
- `universe.capabilities.knowledgeCorpus`
...
A shared module can be reused by any future host by declaring the required capability.
